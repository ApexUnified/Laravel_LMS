                    ...
                    <Card
                        Content={
                            <>
                                ...
                                <div className="flex flex-wrap items-center justify-center gap-4 py-4 my-5 text-base text-gray-800 dark:text-white sm:text-lg">
                                    {/* Instructor */}
                                ...
                                {lesson.attachments && lesson.attachments.map((file, index) => {
                                    ...
                                    return (
                                        <li key={index} className="flex items-center justify-between p-3 my-4 bg-gray-100 rounded-lg shadow-sm dark:bg-gray-800">
